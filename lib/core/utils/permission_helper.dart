  ...
  static Future<bool> showPermissionDialog(BuildContext context) async {
    return await showDialog<bool>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text(AppString.permissionNotificationTitle.getI18n(context)),
          content: Text(AppString.permissionNotificationDescription.getI18n(context)),
          actions: [
            TextButton(
              onPressed: () => Navigator.of(context).pop(false),
              child: Text(AppString.permissionLaterButton.getI18n(context)),
            ),
            ElevatedButton(
    ...
    return await showDialog<bool>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(AppString.permissionExactAlarmDescription.getI18n(context)),
          actions: [
            TextButton(
              onPressed: () => Navigator.of(context).pop(false),
              child: Text(AppString.permissionNormalModeButton.getI18n(context)),
            ),
            ElevatedButton(
              onPressed: () => Navigator.of(context).pop(true),
              child: Text(AppString.permissionGrantButton.getI18n(context)),
